...
const jsonRoutes: MockRoute[] = [
  ...
  file('large', 'large.json'),
  file('large/html', 'large/html.json'),
  file('large/link', 'large/link.json'),
  file('large/html-link', 'large/html-link.json'),
  file('large/array', 'large/array.json'),
  file('large/array/html', 'large/array/html.json'),
  file('large/array/link', 'large/array/link.json'),
  file('large/array/html-link', 'large/array/html-link.json'),
  file('large/timestamp', 'large/timestamp.json'),
  file('medium', 'medium.json'),
  file('medium/html', 'medium/html.json'),
  file('medium/link', 'medium/link.json'),
  file('medium/html-link', 'medium/html-link.json'),
  file('medium/array', 'medium/array.json'),
  file('medium/array/html', 'medium/array/html.json'),
  file('medium/array/link', 'medium/array/link.json'),
  file('medium/array/html-link', 'medium/array/html-link.json'),
  file('medium/timestamp', 'medium/timestamp.json'),
  file('xlarge', 'xlarge.json'),
  file('xlarge/html', 'xlarge/html.json'),
  file('xlarge/link', 'xlarge/link.json'),
  file('xlarge/html-link', 'xlarge/html-link.json'),
  file('xlarge/array', 'xlarge/array.json'),
  file('xlarge/array/html', 'xlarge/array/html.json'),
  file('xlarge/array/link', 'xlarge/array/link.json'),
  file('xlarge/array/html-link', 'xlarge/array/html-link.json'),
  file('xlarge/timestamp', 'xlarge/timestamp.json'),
  file('full/nested', 'fixtures/nested.json'),
  file('full/array-values-nested', 'fixtures/array_values_nested.json'),
  file('full/data-30kb', 'fixtures/data_30kb.json'),
  file('full/data-100kb', 'fixtures/data_100kb.json'),
  file('full/data-300kb', 'fixtures/data_300kb.json'),
  file('full/data-400kb', 'fixtures/data_400kb.json'),
  file('full/data-500kb', 'fixtures/data_500kb.json'),
  file('full/data-1mb', 'fixtures/data_1mb.json'),
  file('full/data-2mb', 'fixtures/data_2mb.json'),
...
const yamlRoutes: MockRoute[] = [
  ...
  file('large', 'large.yaml'),
  file('large/flow', 'large/flow.yaml'),
  file('large/anchors', 'large/anchors.yaml'),
  file('large/multi-doc', 'large/multi-doc.yaml'),
  file('medium', 'medium.yaml'),
  file('medium/flow', 'medium/flow.yaml'),
  file('medium/anchors', 'medium/anchors.yaml'),
  file('medium/multi-doc', 'medium/multi-doc.yaml'),
  file('xlarge', 'xlarge.yaml'),
  file('xlarge/flow', 'xlarge/flow.yaml'),
  file('xlarge/anchors', 'xlarge/anchors.yaml'),
  file('xlarge/multi-doc', 'xlarge/multi-doc.yaml'),
...
const cssRoutes: MockRoute[] = [
  ...
  file('vendor.min', 'vendor.min.css'),
